library(rstan)
options( mc.cores = 4 )
source( 'https://raw.githubusercontent.com/holtz27/rbras/main/source/vgamma_estudo1.R' )
...
x = vgamma_estudo1( M = 500,
             ...
             y0 = 0,
             T = 2e3 )
save(x, file = 'vgamma_estudo1.RData')
load(file = 'vgamma_estudo1.RData')
